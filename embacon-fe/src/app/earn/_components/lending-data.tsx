  ...
  return (
    <div className="min-h-screen text-white">
      <main className="max-w-7xl mx-auto">
        ...
        <div className="bg-slate-800 border border-[#9EC6F3] rounded-lg overflow-hidden">
          <CardContent className="p-0">
            <div className="overflow-x-auto">
              <table className="w-full">
                <thead>
                  <tr className="border-b border-[#9EC6F3]">
                    <th className="text-center p-4 text-sm font-medium text-[#1857ea]">
                      Loan
                    </th>
                    <th className="text-left p-4 text-sm font-medium text-[#1857ea]">
                  ...
                  {lpData.length > 0 ? (
                    ...
                    <tr>
                      <td colSpan={5} className="p-4 text-center">
                        <div className="text-[#1857ea] py-8">
                          <div className="flex flex-col items-center gap-4">
                            <PlusCircle className="w-12 h-12 text-[#1857ea] opacity-80" />
                            <p className="text-lg font-medium">There is no lending pool here</p>
                            <div className="flex items-center gap-2 text-sm text-[#1857ea] opacity-80">
      ...
      <div className="mt-8 max-w-7xl mx-auto grid-cols-1 md:grid-cols-2 gap-6 hidden">
        <Card className="bg-slate-800 backdrop-blur-sm border border-[#9EC6F3] p-5 rounded-xl">
          <h3 className="text-lg font-medium text-[#1857ea] mb-4">
            Market Overview
          </h3>
          <div className="space-y-4">
            ...
            <div className="flex justify-between items-center">
              <div className="flex items-center gap-2">
                <div className="w-6 h-6 bg-[#1857ea] bg-opacity-20 rounded-full"></div>
