    ...
    <div className="mt-15 p-6">
      <div className="max-w-7xl mx-auto space-y-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <Card className="border border-[#9EC6F3] shadow-sm backdrop-blur-sm overflow-hidden group h-full">
            <CardHeader className="pb-2">
              <div className="flex justify-between items-center">
                <CardTitle className="text-[#1857ea] text-lg font-medium">
                  Total Value Locked
                </CardTitle>
                <div className="border border-[#9EC6F3] p-2 rounded-lg text-[#1857ea]">
            ...
            <CardContent className="flex flex-col justify-between h-[calc(100%-88px)]">
              <div className="flex flex-col gap-1">
                <div className="text-3xl font-bold text-gray-300">$247.92M</div>
          ...
          <Card className="border border-[#9EC6F3] shadow-sm backdrop-blur-sm overflow-hidden group h-full">
            <CardHeader className="pb-2">
              <div className="flex justify-between items-center">
                ...
                <div className="border border-[#9EC6F3] p-2 rounded-lg text-[#00EDBE]">
            ...
            <CardContent className="flex flex-col justify-between h-[calc(100%-88px)]">
              <div className="flex flex-col gap-1">
                <div className="text-3xl font-bold text-gray-300">$189.45M</div>
                <div className="flex items-center text-[#00EDBE] text-sm font-medium">
                  <ArrowUp className="h-4 w-4 mr-1" />
                  <span>+3.7% (24h)</span>
                </div>
          ...
          <Card className="border border-[#9EC6F3] shadow-sm backdrop-blur-sm overflow-hidden group h-full">
            ...
            <CardContent className="flex flex-col justify-between h-[calc(100%-88px)]">
              <div className="flex flex-col gap-1">
                <div className="text-3xl font-bold text-gray-300">$58.47M</div>
