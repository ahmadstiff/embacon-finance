...
const Navbar: React.FC = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50">
      <div className="absolute inset-0 glass border-b border-blue-400/20" />
      <div className="relative flex items-center justify-between h-20 px-4 md:px-16 max-w-9xl mx-auto">
